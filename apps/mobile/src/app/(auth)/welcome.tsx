  ...
  return (
    <SafeAreaView className="flex-1 bg-zinc-50 dark:bg-zinc-950">
      <View className="flex-1 justify-center items-center px-6">
        ...
        <Text className="text-3xl font-extrabold text-zinc-900 dark:text-zinc-100 text-center mb-3">
          Welcome to Nestara
        </Text>
        ...
        <View className="w-full">
          ...
          <TouchableOpacity
            ...
            className="w-full bg-zinc-200 dark:bg-zinc-800 rounded-xl py-4 items-center"
          >
            <Text className="text-zinc-900 dark:text-zinc-100 font-semibold text-lg">Sign In</Text>
          </TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
