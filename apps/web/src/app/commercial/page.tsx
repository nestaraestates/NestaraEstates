...
export default async function CommercialPropertiesPage({ searchParams }: { searchParams: Promise<{ [key: string]: string | string[] | undefined }> }) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-zinc-500 dark:text-zinc-400">Discover premium commercial spaces verified for your business.</p>
      </div>
