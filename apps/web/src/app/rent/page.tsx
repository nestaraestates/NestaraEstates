...
export default async function RentPropertiesPage({ searchParams }: { searchParams: Promise<{ [key: string]: string | string[] | undefined }> }) {
  ...
  if (search) {
    ...
    // If the search term is 3 or more characters, also match by the first 3 characters 
