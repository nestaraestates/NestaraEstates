      ...
      <html lang="en">
        <body className={`${geistSans.variable} ${geistMono.variable} antialiased min-h-screen bg-zinc-50 flex items-center justify-center p-4`}>
          <div className="bg-white p-8 rounded-xl shadow-sm border border-zinc-200 text-center max-w-md w-full">
            ...
            <p className="text-zinc-500 mb-4">You do not have administrator privileges to access this portal.</p>
            <div className="bg-zinc-50 border border-zinc-200 rounded-md py-2 px-3 mb-6 flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2 text-sm break-all">
              <span className="text-zinc-500">Attempted login with:</span>
